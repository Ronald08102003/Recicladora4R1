...
// ================= RUTAS HTML =================
app.get('/', (req, res) => res.sendFile(path.join(__dirname, 'public', 'Recicladora4R.html')));
app.get('/login', (req, res) => res.sendFile(path.join(__dirname, 'public', 'login.html')));
app.get('/registro', (req, res) => res.sendFile(path.join(__dirname, 'public', 'Registro.html')));
app.get('/olvide_password', (req, res) => res.sendFile(path.join(__dirname, 'public', 'restablecer.html')));
app.get('/panel_admin', (req, res) => res.sendFile(path.join(__dirname, 'public', 'panel.html')));
app.get('/panel_usuario', (req, res) => res.sendFile(path.join(__dirname, 'public', 'panel_usuario.html')));
app.get('/carrito', (req, res) => res.sendFile(path.join(__dirname, 'public', 'carrito.html')));
app.get('/mis_pedidos', (req, res) => res.sendFile(path.join(__dirname, 'public', 'mis_pedidos.html')));
app.get('/gestionar_pedidos', (req, res) => res.sendFile(path.join(__dirname, 'public', 'gestionar_pedidos.html')));
...
app.get('/reportes', (req, res) => res.sendFile(path.join(__dirname, 'public', 'reportes.html')));
app.get('/gestion_ventas', (req, res) => res.sendFile(path.join(__dirname, 'public', 'gestion_ventas.html')));
app.get('/finalizar_pedido', (req, res) => res.sendFile(path.join(__dirname, 'public', 'finalizar_pedido.html')));
app.get('/ver_detalle', (req, res) => res.sendFile(path.join(__dirname, 'public', 'ver_detalle.html')));
...
app.post('/api/login', async (req, res) => {
    try {
        ...
        if (clave.trim() !== user.clave.trim()) return res.json({ success: false, message: 'Clave incorrecta' });
